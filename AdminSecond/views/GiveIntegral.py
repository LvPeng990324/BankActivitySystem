...
class GiveIntegral(View):
    ...
    def get(self, request):
        ...
        customers = Customer.objects.filter(
            activityrecord__admin_third__in=admin_thirds,
        )
        ...
        return render(request, 'AdminSecond/give-integral.html', context=context)
    ...
    def post(self, request):
        ...
        try:
            ...
            return redirect('AdminSecond:give_integral')
        # 取到该客户了
